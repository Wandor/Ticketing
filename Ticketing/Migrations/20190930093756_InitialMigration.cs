        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TwitterHandle = table.Column<string>(maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SupportAgents", x => x.SupportAgentID);
                    table.ForeignKey(
                        name: "FK_SupportAgents_AspNetUsers_ApplicationUserID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SupportEngineers_AspNetUsers_ApplicationUserID",
                        column: x => x.ApplicationUserID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupportAgents_ApplicationUserID",
                table: "SupportAgents",
                column: "ApplicationUserID");

            migrationBuilder.CreateIndex(
                name: "IX_SupportEngineers_ApplicationUserID",
